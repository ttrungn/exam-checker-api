...
namespace Exam.Services.Features.Account.Queries.GetModerators;
public record GetModeratorsQuery : IRequest<DataServiceResponse<GetExaminersDto>>
{
...
public class GetModeratorsQueryValidator : AbstractValidator<GetModeratorsQuery>
{
    public GetModeratorsQueryValidator()
    {
...
public class GetExaminersHandler
    : IRequestHandler<GetModeratorsQuery, DataServiceResponse<GetExaminersDto>>
{
        ...
        CancellationToken ct)
    {
        ...
        try
        {
            ...
            var examinerRole = appRoles.FirstOrDefault(r => r.Value == Roles.Moderator);
